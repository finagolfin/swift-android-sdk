...
25c](https://developer.android.com/ndk/downloads) and [Swift 5.8
...
```
ln -sf /home/yourname/swift-5.8-RELEASE-ubuntu22.04/usr/lib/clang/13.0.0
...
2. The path to the compiler should change from `/home/butta/swift-5.8-RELEASE-ubuntu22.04`
to the path to your Swift compiler, `/home/yourname/swift-5.8-RELEASE-centos7`.
...
/home/yourname/swift-5.8-RELEASE-ubuntu22.04/usr/bin/swift build --build-tests
...
scp yourname@192.168.1.1:{swift-5.8-android-24-sdk.tar.xz,
...
Download the Swift 5.8 compiler and Android NDK 25c as above. Check out this
repo and run
`SWIFT_TAG=swift-5.8-RELEASE ANDROID_ARCH=aarch64 swift get-packages-and-swift-source.swift`
to get some prebuilt Android libraries and the Swift source to build the SDK. If
you pass in a different tag like `swift-DEVELOPMENT-SNAPSHOT-2023-04-01-a`
...
--build-swift-tools=0 --native-swift-tools-path=/home/butta/swift-5.8-RELEASE-ubuntu22.04/usr/bin/
--native-clang-tools-path=/home/butta/swift-5.8-RELEASE-ubuntu22.04/usr/bin/
...
Finally, it gets [the 5.8 source](https://github.com/apple/swift/releases/tag/swift-5.8-RELEASE)
