...
var repoTags = ["swift-system" : "1.1.1", "swift-collections" : "1.0.1", "swift-asn1" : "0.8.0",
                "swift-certificates" : "0.4.1", "Yams" : "5.0.1", "swift-argument-parser" : "1.2.2",
                "swift-crypto" : "2.5.0"]
...
if swiftBranch == "RELEASE" {
  repoTags["swift-certificates"] = "0.7.0"
